...
const palabras = ['ilse', 'castillo', 'bermudez', 'castillo', 'vagabundo'];
...
const nombres = ['ilse', 'gavi', 'enrique'];
console.log(elements.join());// "ilse,gavi,enrique"
console.log(elements.join(''));// "ilsegavienrique"
console.log(elements.join('-'));// "ilse-gavi-enrique"
